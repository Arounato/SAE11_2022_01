...
#define IMAGE_CARTE_VERSO "/home/bob/SAE11_2022/Jeux/PhotoCarteDeJeuxVerso/64/symboleberserk.jpg"//AJOUT ************
#define CarteRecto "/home/bob/SAE11_2022/Jeux/PhotoCarteDeJeuxRecto/cartes64"//MODIF ************
#define L 1070 //longueur de la page de la fenêtre
#define H 601 //hauteur de la page de la fenêtre
#define DIM 8 //dimension des carrés
#define NB_IMAGES_UNIQUES DIM*DIM/2 //AJOUT ************
#define LHCARTE 64 //longueur et larger des images dans les carrés associés à DIM=4 //AJOUT ************
#define LHCARRE 72 //petit espace avant le petit carré + taille du petit carré - longueur et larger des carrés associés à DIM=4 //AJOUT ************
